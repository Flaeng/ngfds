...
import { FdsAccordionModule } from 'projects/dkfds-angular-components/src/lib/accordion/accordion.module';
import { FdsAlertModule } from 'projects/dkfds-angular-components/src/lib/alert/alert.module';
import { FdsBadgeModule } from 'projects/dkfds-angular-components/src/lib/badge/badge.module';
import { FdsBreadcrumbsModule } from 'projects/dkfds-angular-components/src/lib/breadcrumbs/breadcrumbs.module';
import { FdsButtonModule } from 'projects/dkfds-angular-components/src/lib/button/button.module';
import { FdsCardModule } from 'projects/dkfds-angular-components/src/lib/card/card.module';
import { FdsDetailsModule } from 'projects/dkfds-angular-components/src/lib/details/details.module';
import { FdsFooterModule } from 'projects/dkfds-angular-components/src/lib/footer/footer.module';
import { FdsHeaderModule } from 'projects/dkfds-angular-components/src/lib/header/header.module';
import { FdsLanguagePickerModule } from 'projects/dkfds-angular-components/src/lib/language-picker/language-picker.module';
import { FdsLinkModule } from 'projects/dkfds-angular-components/src/lib/link/link.module';
import { FdsOverflowMenuModule } from 'projects/dkfds-angular-components/src/lib/overflow-menu/overflow-menu.module';
import { FdsPaginationModule } from 'projects/dkfds-angular-components/src/lib/pagination/pagination.module';
import { FdsSideNavigationModule } from 'projects/dkfds-angular-components/src/lib/side-navigation/side-navigation.module';
import { FdsSkipLinkModule } from 'projects/dkfds-angular-components/src/lib/skip-link/skip-link.module';
import { FdsSpinnerModule } from 'projects/dkfds-angular-components/src/lib/spinner/spinner.module';
import { FdsStepIndicatorModule } from 'projects/dkfds-angular-components/src/lib/step-indicator/step-indicator.module';
import { FdsTextareaModule } from 'projects/dkfds-angular-components/src/lib/textarea/textarea.module';
import { FdsTooltipModule } from 'projects/dkfds-angular-components/src/lib/tooltip/tooltip.module';
...
import { FdsCookieMessageModule } from 'projects/dkfds-angular-components/src/lib/cookie-message/public-api';
import { TabsPageComponent } from './pages/tabs-page/tabs-page.component';
import { FdsTabsModule } from 'projects/dkfds-angular-components/src/lib/tabs/tabs.module';
import { FdsIconsModule } from 'projects/dkfds-angular-components/src/lib/icon/icons.module';
import { IconsPageComponent } from './pages/icon-page/icon-page.component';
import { FdsTagModule } from 'projects/dkfds-angular-components/src/lib/tag/tag.module';
import { TagPageComponent } from './pages/tag-page/tag-page.component';
import { ToastPageComponent } from './pages/toast-page/toast-page.component';
import { FDS_TOAST_OPTIONS, IToastOptions } from 'projects/dkfds-angular-components/src/lib/toast/toast.service';
import { BackButtonPageComponent } from './pages/back-button-page/back-button-page.component';
import { FdsBackButtonModule } from 'projects/dkfds-angular-components/src/lib/back-button/back-button.module';
import { FunctionLinkPageComponent } from './pages/function-link-page/function-link-page.component';
import { FdsFunctionLinkModule } from 'projects/dkfds-angular-components/src/lib/function-link/function-link.module';
import { StructuredListPageComponent } from './pages/structured-list-page/structured-list-page.component';
import { FdsStructuredListModule } from 'projects/dkfds-angular-components/src/lib/structured-list/structured-list.module';
import { DateInputPageComponent } from './pages/date-input-page/date-input-page.component';
import { FdsDateInputModule } from 'projects/dkfds-angular-components/src/lib/date-input/date-input.module';
import { FormsModule, ReactiveFormsModule } from '@angular/forms';
import { DatePickerPageComponent } from './pages/date-picker-page/date-picker-page.component';
import { FdsDatePickerModule } from 'projects/dkfds-angular-components/src/lib/date-picker/date-picker.module';
